				...
				<div class="row">
					<div class="span12">
						<ul class="thumbnails listing-products">
									<?php
										$query = mysql_query("SELECT * FROM exames where paciente_id='$id' and procedimento_id='$idproc'");
										...
										$nome1 = $ge['nome'];
										$a= mysql_query(SELECT COUNT(*) FROM exames where paciente_id='$id' and procedimento_id='$idproc'");
										$get_ = mysql_fetch_assoc($a);
										$qtd = $get_['paciente_id'];
