					...
					<div class="span12">
						<ul class="thumbnails listing-products">
									<?php
										...
										$page_query = mysql_query("SELECT COUNT(*) FROM pacientes");
										$pages = ceil(mysql_result($page_query, 0) / $per_page);

										$page = (isset($_GET['page'])) ? (int)$_GET['page'] : 1;
										$start = ($page - 1) * $per_page;

										$query = mysql_query("SELECT * FROM pacientes order by nome");
			...
			<section id="footer-bar">
				<div class="row">
					...
					<div class="span5">
						...
						<p>Nossa loja online de pacientes para o seu pet</p>
						<br/>
